...
# Datos consolidados de los 84 hermanos de El Araguaney
data = {
    "Nombre": [
        # GRUPO 1
    ...
    "Privilegio": [
        "Anciano", "Siervo Min.", "Publicador", "Publicador", "Publicador", "Publicador", "Publicador", "Publicador", "Publicador", "Publicador", "Publicador", "Publicador", "Publicador", # G1
        "Anciano", "Siervo Min.", "Publicador", "Publicador", "Publicador", "Publicador", "Publicador", "Publicador", "Publicador", "Publicador", "Publicador", "Publicador", "Publicador", # G2
        "Anciano", "Siervo Min.", "Publicador", "Publicador", "Publicador", "Publicador", "Publicador", "Publicador", "Publicador", "Publicador", "Publicador", "Publicador", "Publicador", # G3
        "Anciano", "Publicador", "Publicador", "Publicador", "Publicador", "Publicador", "Publicador", "Publicador", "Publicador", "Publicador", "Publicador", # G4
        "Anciano", "Publicador", "Publicador", "Publicador", "Publicador", "Publicador", "Publicador", "Publicador", "Publicador", "Publicador", # G5
        "Anciano", "Publicador", "Publicador", "Publicador", "Publicador", "Publicador", "Publicador", "Publicador", "Publicador", "Publicador", "Publicador", "Publicador", "Publicador", "Publicador", "Publicador", # G6
        "Anciano", "Publicador", "Publicador", "Publicador", "Publicador", "Publicador", "Publicador", "Publicador", "Publicador" # G7
    ],
...
# Crear DataFrame y guardar el archivo
df = pd.DataFrame(data)
df.to_excel("Congregacion_Araguaney.xlsx", index=False)

print("-" * 50)
print("¡Archivo 'Congregacion_Araguaney.xlsx' creado con éxito!")
print(f"Total de hermanos registrados: {len(df)}")
print("-" * 50)