    ...
    def abrir_selector_candidato(self, semana_idx, rol, valor_actual, campo_json, skill_col, sub_idx=None):
        ...
        def build_tiles(filter_text=""):
            ...
            for item in sugerencias:
                ...
                color_bg = "#FFE0B2" if item['Ocupado'] else "#E8F5E9" if item['Privilegio'] == 'Anciano' else "white" if not self.page.theme_mode == ft.ThemeMode.DARK else ft.colors.SURFACE_VARIANT
